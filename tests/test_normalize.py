...
def test_extract_post_id_from_twitter_url():
    from tweety_mcp.normalize import extract_post_id
...
def test_extract_post_id_rejects_invalid_url():
    from tweety_mcp.normalize import NormalizationError, extract_post_id
...
def test_normalize_author_accepts_handle_and_profile_url():
    from tweety_mcp.normalize import normalize_author
